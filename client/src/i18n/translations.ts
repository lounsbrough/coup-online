...
export type Translations = ActionMessages & AlertColorTranslations & {
  ...
  snarkyDeadComments: { [key in AvailableLanguageCode]: string[] };
...
const translations: Translations = {
  ...
  [EventMessages.ActionPending]: {
    ...
    [Actions.ForeignAid]: {
      ...
      "hi-IN": "{{primaryPlayer}} {{action[[विदेशी सहायता]]}} प्राप्त करने की कोशिश कर रहा है",
    ...
    [Actions.Tax]: {
      ...
      "hi-IN": "{{primaryPlayer}} {{action[[Tax]]}} एकत्रित करने का प्रयास कर रहा है",
  ...
  [EventMessages.ActionProcessed]: {
    ...
    [Actions.ForeignAid]: {
      ...
      "hi-IN": "{{primaryPlayer}} ने {{action[[विदेशी सहायता]]}} प्राप्त करने की कोशिश की",
  ...
  [EventMessages.BlockPending]: {
    ...
    "hi-IN": "{{primaryPlayer}} {{secondaryPlayer}} को {{primaryInfluence}} के रूप में ब्लॉक करने की कोशिश कर रहा है",
  ...
  [EventMessages.BlockSuccessful]: {
    ...
    "hi-IN": "{{primaryPlayer}} ने {{secondaryPlayer}} को सफलतापूर्वक ब्लॉक किया",
  ...
  [EventMessages.ChallengeFailed]: {
    ...
    "hi-IN": "{{primaryPlayer}} ने {{secondaryPlayer}} को चुनौती देने में विफल रहा",
  ...
  [EventMessages.ChallengePending]: {
    ...
    "hi-IN": "{{primaryPlayer}}, {{secondaryPlayer}} को चुनौती देने की कोशिश कर रहा है",
  ...
  [EventMessages.ChallengeSuccessful]: {
    ...
    "hi-IN": "{{primaryPlayer}} ने {{secondaryPlayer}} को सफलतापूर्वक चुनौती दी",
  ...
  [EventMessages.PlayerReplacedInfluence]: {
    ...
    "hi-IN": "{{primaryPlayer}} ने अपना {{primaryInfluence}} प्रकट और प्रतिस्थापित किया",
  ...
  [EventMessages.PlayerReplacedWithAi]: {
    ...
    "hi-IN": "{{primaryPlayer}} को एक एआई खिलाड़ी द्वारा प्रतिस्थापित किया गया है",
  ...
  forfeitConfirmationMessage: {
    ...
    "hi-IN": "क्या आप अपने प्रभावों को मारना चाहते हैं या एक एआई खिलाड़ी द्वारा प्रतिस्थापित होना चाहते हैं?",
  ...
  keepInfluences: {
    ...
    "hi-IN": "रखें {{primaryInfluence}}{{plural[[ और {{secondaryInfluence}}]]}}",
  ...
  rulesAmbassador: {
    ...
    "hi-IN": "आप अपने प्रभाव कार्डों को डेक से नए कार्डों के साथ बदल सकते हैं और चोरी के प्रयासों को रोक सकते हैं।",
  ...
  rulesAssassinate: {
    ...
    "hi-IN": "तीन सिक्कों की लागत। एक खिलाड़ी को अपनी पसंद की एक प्रभाव कार्ड छोड़ने के लिए मजबूर करता है। इसे चुनौती दी जा सकती है। इसे कोंटेसा द्वारा रोका जा सकता है।",
  ...
  rulesCaptain: {
    ...
    "hi-IN": "एक खिलाड़ी से दो सिक्के चुरा सकता है और चोरी के प्रयासों को रोक सकता है।",
  ...
  rulesCoup: {
    ...
    "hi-IN": "सात सिक्कों की लागत। एक खिलाड़ी को एक प्रभाव कार्ड छोड़ने के लिए मजबूर करता है। चुनौती या अवरुद्ध नहीं किया जा सकता है। यदि आप अपना टर्न दस या अधिक सिक्कों के साथ शुरू करते हैं, तो आपको एक तख्तापलट करना होगा (या सक्षम होने पर पुनर्जीवित करना होगा)।",
  ...
  rulesExchange: {
    ...
    "hi-IN": "डेक से दो प्रभाव कार्ड खींचें, उन्हें देखें और उन्हें अपने वर्तमान प्रभाव कार्ड के साथ मिलाएं। दो कार्ड वापस डेक में रखें और डेक को शफल करें। चुनौती दी जा सकती है। अवरुद्ध नहीं किया जा सकता।",
  ...
  rulesForeignAid: {
    ...
    "hi-IN": "बैंक से दो सिक्के लें। चुनौती नहीं दी जा सकती। ड्यूक द्वारा अवरुद्ध किया जा सकता है।",
  ...
  rulesIncome: {
    ...
    "hi-IN": "बैंक से एक सिक्का लें। चुनौती नहीं दी जा सकती। अवरुद्ध नहीं किया जा सकता।",
  ...
  rulesLosingAChallenge: {
    ...
    "hi-IN": "कोई भी खिलाड़ी जो एक चुनौती हारता है, उसे अपने प्रभाव कार्ड में से एक को सभी के सामने उल्टा करना चाहिए। यदि यह उसका अंतिम प्रभाव कार्ड है, तो वह खेल से बाहर है।",
  ...
  rulesLosingInfluence: {
    ...
    "hi-IN": "जब भी कोई खिलाड़ी एक प्रभाव कार्ड खोता है, तो वह अपनी किसी भी कार्ड को प्रकट करने के लिए चुनता है।",
  ...
  rulesRevive: {
    ...
    "hi-IN": "मानक खेल में उपलब्ध नहीं है, लेकिन इसे एक नया खेल बनाते समय सक्रिय किया जा सकता है। इसकी लागत दस सिक्के है। यह डिस्कार्ड पाइल से एक प्रभाव कार्ड को पुनर्जीवित करता है। इसे चुनौती नहीं दी जा सकती और न ही अवरुद्ध किया जा सकता है।",
  ...
  rulesSteal: {
    ...
    "hi-IN": "दूसरे खिलाड़ी से दो सिक्के लें। इसे चुनौती दी जा सकती है। इसे कप्तान या राजदूत द्वारा अवरुद्ध किया जा सकता है।",
  ...
  rulesTax: {
    ...
    "hi-IN": "बैंक से तीन सिक्के लें। इसे चुनौती दी जा सकती है। इसे अवरुद्ध नहीं किया जा सकता है।",
