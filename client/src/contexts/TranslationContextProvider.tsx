...
import { EventMessages, AvailableLanguageCode } from '@shared'
import { activeLanguageStorageKey } from '../helpers/localStorageKeys'
import translations, { Translations } from '../i18n/translations'
import { usePersistedState } from '../hooks/usePersistedState'
import { TranslationContext, TranslationVariables } from './TranslationsContext'
...
function TranslationContextProvider({ children }: Readonly<{ children: ReactNode }>) {
  ...
  const getTranslation = useCallback((key: keyof Translations, variables?: Partial<TranslationVariables>): ReactNode => {
    ...
    const influenceKeys: Array<'primaryInfluence' | 'secondaryInfluence'> = [
      'primaryInfluence',
      'secondaryInfluence'
    ]
    ...
    const playerKeys: Array<'primaryPlayer' | 'secondaryPlayer'> = [
      'primaryPlayer',
      'secondaryPlayer'
    ]
